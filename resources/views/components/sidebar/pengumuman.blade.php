<div x-data="{
    openPengumuman: {{ request()->routeIs('pengumuman.*') ? 'true' : 'false' }}
}" class="mb-2">
    <!-- Header collapsible -->
    <div class="border-b-2 mb-2 py-2 cursor-pointer flex items-center justify-between"
        @click="openPengumuman = !openPengumuman">
        <span>Pengumuman</span>

        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 transform transition"
            :class="openPengumuman ? 'rotate-90' : ''" viewBox="0 0 20 20" fill="currentColor">
