<div class="flex flex-col mb-10 space-y-7">
    <h2 class="text-2xl font-bold text-slate-600">Form Edit Data Pendaftar</h2>
    {{-- Identitas Siswa --}}
    <x-card class="flex flex-col space-y-4 mb-3 ">
        <div class="flex flex-col my-3 space-y-4 mb-3 lg:grid lg:grid-cols-3 lg:gap-2 lg:space-y-0 ">
            <x-siakad.tahun wire:model='tahun' />
    ...
    <x-card
        ...
        <div class="flex flex-col space-y-4 mb-3 llg:grid lg:grid-cols-2 lg:gap-2 lg:space-y-0">
            <x-input wire:model="nama_sekolah_asal" label="Nama Sekolah Asal" />
        </div>
        <div class="flex flex-col space-y-4 mb-3 lg:grid lg:grid-cols-4 lg:gap-2 lg:space-y-0">
    ...
    <div class="flex justify-end space-x-3">
        <x-button href="{{ route('pendaftaran.data-pendaftar') }}" wire:navigate label="Batal" slate />
